...
\fcolorbox{red}{sidebg}{
    \begin{minipage}[t][\textheight-2\fboxsep-2\fboxrule][t]{\dimexpr0.4\textwidth-2\fboxrule-2\fboxsep\relax}
        ...
        \vspace{0.7cm} \\
        \faUserAstronaut{} & \small Highly committed to individual and teams challenges, I really enjoy thinking about the best solution to address problems and I truly believe in continuous learning and teamwork.\\
        \vspace{0.5cm}
...
%
        ...
        \vspace{.10cm} \\ 
        {\footnotesize \faAngleRight & Integrated on an (essentially) back end, under Agile Methodologies, with a highly sparsed growing technical environment I had responsibilities such as:
        \vspace{.10cm} \\ 
        \begin{itemize}
            \setlength{\itemsep}{-2pt}
            \item Define, design and implement architectures, systems, applications or business processes;
            \item Ensurance of premises such as security, performance, integrity, scalability, reliability;
        ...
        \end{itemize}} 
        {\footnotesize \textbf{Tech Stack:} Azure DevOps, CI/CD, Git, Elastic Stack (ELK), Sonarqube, .NET Framework, ASP.NET, SQL, C#}
        \vspace{0.5cm} \\         
        
        % MIND SOURCE
        {\large \textbf{Mind Source}} \\
        \vspace{.10cm} \\ 
        {{\fontseries{medium}\selectfont Cosultant}}\\
        ...
        \vspace{.10cm} \\       
        {\footnotesize \faAngleRight & With a strong program aimed at the development and evolution of skills, I worked on both internal and client projects with a permanent assignment. \\As a Full-Stack developer,
        I had challenges such as: 
        \vspace{.10cm} \\ 
        \begin{itemize}
            \setlength{\itemsep}{-2pt}
            ...
            \item Development of internal applications and webservices;
            \item Product development;
        \end{itemize}}
        {\footnotesize \textbf{Tech Stack:} .NET Framework, ASP.NET, SQL, C\#, Full-Stack Development, Visual Basic .NET (VB.NET), MVC, WPF Development, Windows Forms, SQL Server Integration Services (SSIS), SQL Server Reporting Services (SSRS), JS, XML, JSON, HTML/CSS}
